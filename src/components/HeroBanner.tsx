...
export default function HeroBanner({ tasks }: Props) {
  ...
  return (
    ...
    <section className="rounded-[2rem] border border-white/5 bg-gradient-to-br from-[#130b2e] via-[#0e0820] to-[#090710] p-6 shadow-[0_20px_120px_-80px_rgba(125,70,255,0.7)] mb-5">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-3">
          <p className="text-xs uppercase tracking-[0.35em] text-purple-400/80">TaskOS</p>
          <h2 className="text-3xl md:text-4xl font-semibold text-white">Tu tablero de tareas con estilo hero.</h2>
          <p className="max-w-xl text-sm text-gray-400">Crea, arrastra y organiza tareas mientras tu tablero se sincroniza con MongoDB y mantiene tus datos seguros.</p>
        </div>
